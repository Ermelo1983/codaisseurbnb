...
# Photos
photo1 = Photo.create(remote_image_url: "http://res.cloudinary.com/janluth/image/upload/v1476358252/images-3_d2msjj.jpg")
photo2 = Photo.create(remote_image_url: "http://res.cloudinary.com/janluth/image/upload/v1476358252/images-4_awrbzy.jpg")
photo3 = Photo.create(remote_image_url: "http://res.cloudinary.com/janluth/image/upload/v1476358252/images_m0ykpe.jpg")

photo4 = Photo.create(remote_image_url: "http://res.cloudinary.com/janluth/image/upload/v1476358252/images-1_unrmpg.jpg")
photo5 = Photo.create(remote_image_url: "http://res.cloudinary.com/janluth/image/upload/v1476358252/images_m0ykpe.jpg")
photo6 = Photo.create(remote_image_url: "http://res.cloudinary.com/janluth/image/upload/v1476358252/images_m0ykpe.jpg")

photo7 = Photo.create(remote_image_url: "http://res.cloudinary.com/janluth/image/upload/v1476358252/images_m0ykpe.jpg")
photo8 = Photo.create(remote_image_url: "http://res.cloudinary.com/janluth/image/upload/v1476358252/images-4_awrbzy.jpg")
photo9 = Photo.create(remote_image_url: "http://res.cloudinary.com/janluth/image/upload/v1476358252/images_m0ykpe.jpg")
